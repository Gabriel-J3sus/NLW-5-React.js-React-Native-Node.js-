...
export function PlantSave() {
  ...
  function handleChangeTime(event: Event, dateTime: Date | undefined) {
    ...
    if (dateTime && isBefore(dateTime, new Date())) {
      ...
      return Alert.alert('Escolha uma hora no futuro!', 'Voltar no tempo é impossivel');
    }
  ...
  async function handleConfirm() {
    try {
      ...
      navigation.navigate('Confirmation', {
        title: 'Tudo certo',
        subtitle: 'Fique tranquilo que sempre vamos lembrar você de cuidar das suas plantinhas com cuidado.',
